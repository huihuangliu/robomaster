...
uint8_t armor::V4L_capture::getImageFromMemory(cv::Mat &image)
{
...
uint8_t armor::V4L_capture::getImageFromMemory()
{
    if(shared_package_ptr==NULL)
        shared_package_ptr=get_shared_package();
...
void armor::V4L_capture::printlog(const char *format,...)
{
    va_list args;
