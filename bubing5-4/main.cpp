...
int title_v_L = 40, title_v_H = 255;//znj
...
int context_v_L = 100, context_v_H = 255;
int context_hight_L = 20, context_hight_H = 120;
int context_width_L = 20, context_width_H = 140;
int HW_height_difference = 150;
int HW_width_difference = 150;
...
int fire_context_v_L = 240, fire_context_v_H = 255;
...
int adjust_context_flag = 1;
int adjust_title_flag = 1;
...
void python_init(){
    ...
    PyRun_SimpleString("sys.path.append('/home/allspark002/build-bubing5-3-unknown-Debug')");
